...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://qvlxlesrfe.execute-api.us-east-1.amazonaws.com/AI-album';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        var searchGetRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['q']),
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Accept', 'x-amz-meta-customLabels', 'item'], ['body']);
